  ...
  return (
    ...
    <div className='page2'>
        ...
        <div className='card1'>
          <p>X+ ONLY</p>
            <div className='frame1'>
              ...
              <div className='col2'>
                <h1>BLACK Platinum Card<br/>(X+ ONLY)</h1>
                <h2>$550 USDC</h2>
                <p>Monthly Top-up Limit: $150,000 USD</p>
              </div>
            </div>
        </div>
          <div className='card2'>
              <p>FOR DEGODS HOLDER</p>
              <div>
      ...
      <div className='division2'>
            ...
            <div className='card5'>
                  <div className='line1'>
                      <p className='p'>Card Application (USD)</p>
                      <p className='p1'>$250</p>
                      <p className='p1'>$550</p>
                      <p className='p1'>$550</p>
                  </div>
                  <div className='line2'>
                      <p className='p'>SolSwipe NFT Requirement</p>
                      <p className='p1'>0</p>
                      <p className='p1'>1</p>
                      <p className='p1'>1</p>
                  </div>
                  <div className='line3'>
                      <p className='p'>Card Replacement Fee (USD)</p>
                      <p className='p1'>100</p>
                      <p className='p1'>200</p>
                      <p className='p1'>200</p>
                  </div>
                  <div className='line4'>
                      <p className='p'>Card Loading Fee (%)</p>
                      <p className='p1'>2.25% (-0.5% for Solswipe <br/>NFT holders)</p>
                      <p className='p1'>2.25% (-0.5% for Solswipe <br/>NFT holders)</p>
                      <p className='p1'>2.25% (-0.5% for Solswipe <br/>NFT holders)</p>
                  </div>
                  <div className='line5'>
                      <p className='p'>Spending Limit (USD)</p>
                      <p className='p1'>N/A</p>
                      <p className='p1'>N/A</p>
                      <p className='p1'>N/A</p>

                  </div>
                  <div className='line6'>
                      <p className='p'>Loading Cap</p>
                      <p className='p1'>$30,000 / Month</p>
                      <p className='p1'>$75,000 / Month</p>
                      <p className='p1'>N/A</p>

                  </div>
                  <div className='line7'>
                      <p className='p'>Minimum First Load</p>
                      <p className='p1'>0 / Month</p>
                      <p className='p1'>0 / Month</p>
                      <p className='p1'>0 / Month</p>
                  ...
                  <div className='line8'>
                  <div className='card6'>
                      <button className='button3'>APPLY FOR THIS CARD</button>
                      <button className='button4'>APPLY FOR THIS CARD</button>
                      <button className='button5'>APPLY FOR THIS CARD</button>
                  </div>
                </div>
                <div className='line9'>
                    <div className='card7'>
                        <h1>Note:</h1>
                        <p>Card issuance fees include the physical card, fright charges, and the opening of offshore bank account. (No bank book).</p>
                    </div>
                </div>
              </div>
          </div>
    </div>
    <div className="page2_svg">
    <svg  height="142" viewBox="0 30 1440 102" fill="none" xmlns="http://www.w3.org/2000/svg"className="x2">
